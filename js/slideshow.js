...
function generateSlideShow(id, folder, images, alts)
{
	countOfSlideShows++;
	...
	var str = '<h2 style="text-align:center">Slideshow Gallery</h2><div class="container"><div class="numbertext" id="numbertext">-/-</div>';
	for(var j = 0; j<images.length; j++)
	{
		str+='<div class="'+mySlides+'"><img class="slide_img" src="'+folder+'\\'+images[j]+'" alt="'+alts[j]+'"></div>';
	}
	str+='<a class="prev" onclick="plusSlides(-1, '+(countOfSlideShows-1)+')">&lt;</a>';
	str+='<a class="next" onclick="plusSlides(1, '+(countOfSlideShows-1)+')">&gt;</a></div><div class="caption-container"><p id="caption"></p></div>';
